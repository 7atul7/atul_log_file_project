...
class Session:
    ...
    cleansed = spark.read.csv("/content/drive/MyDrive/project_output_files/raw_layer/part-00000-91abf520-2b42-4fa9-a77a-37d8aceeb1d0-c000.csv",header=True)
    ...
    def read_raw_data_from_s3(self):
        try:
            ...
            self.cleansed = self.spark.read.csv("/content/drive/MyDrive/project_output_files/raw_layer/part-00000-91abf520-2b42-4fa9-a77a-37d8aceeb1d0-c000.csv",header=True)
...
class CleansedLayer(Session):
    ...
    def save_to_s3(self):
        self.cleansed.write.csv("/content/drive/MyDrive/project_output_files/cleansed_Layer/", mode="overwrite",header=True)

    def save_to_hive_table(self):
        pass
        self.cleansed.write.saveAsTable('cleansed_table3')
        print("count of cleansed_hive_table")
        self.spark.sql("select count(*) from cleansed_table3").show()
